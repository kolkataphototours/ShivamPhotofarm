    ...
    return (
        <Link href={`/films/${index}`} class="relative m-4 shadow-lg border-8 shadow-gray-500 border-white rounded-xl overflow-hidden">
            ...
            <div className='border-4'>
                <div>
                    <h1 class="border-2 text-white text-2xl md:text-3xl text-center font-sang  font-bold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                        {details[index].place}
                    </h1>
                </div>
                {/* <div>

                    <p class="text-white text-2xl md:text-3xl text-center font-sang  font-bold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                        {details[index].name}
                    </p>
                </div> */}
            </div>
