    ...
    return (
        <div className="bg-transparent shadow-sm w-full  text-gray-500 container-fluid">
            <div className="flex justify-between items-center mx-4 h-16 ">
                <h1 className="md:text-3xl font-semibold font-sang">Shivam PhotoFarm</h1>

                <div onClick={toggleMenu} className="cursor-pointer z-20" >
                    <motion.div variants={firstLine} initial="initial" animate={isOpen ? 'final' : 'initial'} className="h-1 bg-gray-500 w-8 m-1"></motion.div>
                    <motion.div variants={middleLine} initial="initial" animate={isOpen ? 'final' : 'initial'} className="h-1 bg-gray-500 w-8 m-1"></motion.div>
                    <motion.div variants={lastLine} initial="initial" animate={isOpen ? 'final' : 'initial'} className="h-1 bg-gray-500 w-8 mx-1"></motion.div>
                </div>
