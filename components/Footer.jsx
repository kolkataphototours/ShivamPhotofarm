      ...
      <div class="w-4/5 bg-gray-300 h-11/12 py-2">
        <section class="page_section contact" id="contact">
          <div class="contact_section  mb-12">
            <h2 class="text-2xl md:text-3xl  text-center mt-4 mb-2 font-sang font-medium">We'd love to hear you</h2>
            ...
            <form ref={form} onSubmit={sendEmail} class="form text-black ">
              <div className='flex flex-col justify-center justify-items-center gap-2 mx-8 md:mx-32 lg:gap-4  '>
                <div className='flex flex-col md:flex-row mr-auto w-full justify-evenly mb-[-10px] md:mb-[-15px] '>
                  <input class="input-text mb-4 p-2 md:w-2/5 md:mr-12  border   bg-zinc-50  border-gray-300 rounded-lg" type="text" name="name" placeholder='Name' />
                  <input class="input-text mb-4 p-2 md:w-2/5 border bg-zinc-50 border-gray-300 rounded-lg" type="text" name="email" placeholder='Email' />
                </div>
                <div className='flex flex-col md:flex-row mr-auto w-full justify-evenly mb-[-10px] md:mb-[-15px]'>
                  <input class="input-text mb-4 p-2 md:w-2/5 md:mr-12  border   bg-zinc-50  border-gray-300 rounded-lg" type="number" name="number" placeholder='Phone No.' />
                  <input class="input-text mb-4 p-2 md:w-2/5 border bg-zinc-50 border-gray-300 rounded-lg" type="date" name="date" placeholder='Date' />
                </div>
                <div className='text-center w-full'>
                  <textarea class="input-text text-area w-full md:w-11/12 mb-2 p-2  border bg-zinc-50 border-gray-300 rounded-lg h-32 " cols="0" rows="" name="message" placeholder='Message'></textarea>
                </div>
                <div className='flex justify-center w-full'>                  
                    <button class="input-btn mt-4 md:mt-0 w-full md:w-2/3 px-4 py-2 bg-gray-800  text-white rounded-xl cursor-pointer font-ste hover:bg-black" type="submit" >Send Message</button>
                </div>
